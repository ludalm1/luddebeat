		...
		if (data.mode !== undefined) {
			...
			switch (data.mode) {
				...
				case 'floatbeat2insteadof1':
					...
					break;
				case 'csdmode':
					this.getValues = (funcValue) => ((d = (funcValue) * 8 / 11025 ) | 0, (( d & 16 ) / 8-1 ) * ( d * (d ^ 15) + d)) / 127.5 - 1;
					this.getValuesVisualizer = (funcValue) => ((d = (funcValue) * 8 / 11025 ) | 0, (( d & 16) / 8-1 ) * ( d * (d ^ 15) + d) + 127);
					break;
