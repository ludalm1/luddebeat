...
globalThis.bytebeat = new class {
	...
	parseUrl() {
		...
		let songData;
		if (hash.startsWith('#v3b64') || hash.startsWith('#EnBeat2-') || hash.startsWith('#GFLJBeat2-')) {
			const hashString = hash.startsWith('#GFLJBeat2-') ? atob(hash.slice(9)) : atob(hash.slice(6));
